...
export const HTTP_NON_AUTHORITATIVE_INFORAMTION = 203;
...
export const HTTP_RANGE_NOT_SATISIFIABLE = 416;
export const HTTP_EXPECTATION_FAILED = 417;
export const HTTP_IM_A_TEAPOT = 418;
export const HTTP_INVALID_CSRF_TOKEN = 419; // Laravel specific
